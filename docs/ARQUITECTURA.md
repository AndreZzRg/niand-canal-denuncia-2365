# Arquitectura — Canal de Denuncia Ley 2365
...
Una carpeta por módulo: `radicar-denuncia`, `consultar-radicado`, `bandeja-del-comite`, `ruta-de-atencion-y-plazos`, `medidas-de-proteccion`.
...
`localStorage` bajo claves con prefijo `niand-canal-denuncia-2365:`.
