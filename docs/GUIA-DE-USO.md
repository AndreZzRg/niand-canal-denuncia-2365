# Guía de uso — Canal de Denuncia Ley 2365

Canal de recepción de denuncias de acoso sexual y acoso laboral con reserva de identidad, radicado verificable mediante hash criptográfico, control de los plazos de la ruta de atención y registro de medidas de protección inmediata.
...
### 3. Bandeja del comité

Módulo de la aplicación.

### 4. Ruta de atención y plazos
...
[https://github.com/AndreZzRg/niand-canal-denuncia-2365/issues](https://github.com/AndreZzRg/niand-canal-denuncia-2365/issues) indicando la norma y el artículo que
...
AndreZzRg · <andresrg1999@hotmail.com> · [Incidencias](https://github.com/AndreZzRg/niand-canal-denuncia-2365/issues)
