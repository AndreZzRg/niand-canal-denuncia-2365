# Registro de decisiones de arquitectura — Canal de Denuncia Ley 2365
...
**Contexto.** GitHub Pages sirve el proyecto bajo `/niand-canal-denuncia-2365/`. Fijar esa ruta en la
