...
export const MODULOS = [
  { id: 'radicar-denuncia', rotulo: 'Radicar denuncia' },
  { id: 'consultar-radicado', rotulo: 'Consultar radicado' },
  { id: 'bandeja-del-comite', rotulo: 'Bandeja del comité' },
  { id: 'ruta-de-atencion-y-plazos', rotulo: 'Ruta de atención y plazos' },
  { id: 'medidas-de-proteccion', rotulo: 'Medidas de protección' },
] as const;
    ...
    <div className="flex min-h-dvh flex-col">
      ...
      <header className="no-imprimir sticky top-0 z-30 border-b border-borde bg-superficie/92 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center gap-x-4 gap-y-2 px-4 py-3 sm:px-6">
          <a
            href="https://github.com/AndreZzRg/niand-canal-denuncia-2365"
            className="shrink-0"
            aria-label="Repositorio de Canal de Denuncia Ley 2365"
          >
            <Logo alto={28} />
          </a>
          ...
          <div className="min-w-0 flex-1">
            <p className="truncate font-display text-sm font-semibold">
              <span aria-hidden>🔒 </span>Canal de Denuncia Ley 2365
            </p>
